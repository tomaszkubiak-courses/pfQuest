...
fork and is the only remote. The original repository was archived in 2025 and its remote has been removed
deliberately: it will never receive another commit, so do not add it back, fetch it, diff against it, or
check it for upstream changes — this fork is the only source of truth.
